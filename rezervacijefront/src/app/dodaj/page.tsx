...
export default function DodajSalu() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Ako ovde dobiješ 401, znači da token nije dobar ili je istekao
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      ...
      >
        ...
        <input
          ...
          className="w-full p-3 border border-pink-200 mb-4 rounded-xl outline-none focus:border-pink-500 [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
          onChange={(e) =>
            setFormData({ ...formData, kapacitet: parseInt(e.target.value) })
          }
        />
